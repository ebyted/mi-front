...
CORS_ALLOW_ALL_ORIGINS = True  # Solo para pruebas, luego restringe
...
LOGGING = {
    ...
    'handlers': {
        ...
        'inventory_file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'inventory_sync.log'),
