          ...
          <tbody>
            {formData.details.map((d, idx) => (
              <tr key={idx}>
                ...
                <td>{d.notes}</td>
                <td>
                  <button type="button" className="btn btn-sm btn-primary me-1" onClick={() => handleEditDetail(idx)}>Editar</button>
                  <button type="button" className="btn btn-sm btn-danger" onClick={() => removeDetail(idx)}>Eliminar</button>
                </td>
              </tr>
            ))}
          </tbody>
